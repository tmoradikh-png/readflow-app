...
| RF-R20 | Free/Reader Plus accidentally incur OCR/OpenAI cost | Free: one native-text book, 300-page cap, 5 rF AI minutes/day. Reader Plus: native-text reading plus 10 downloaded rF AI minutes/day; no OCR/Cloud AI/text AI. AI Pro/Power rF AI is unlimited | Backend canonical plan and mobile fallback; exercise server gates |
